...
In GPI, the value function is repeatly driven toward the true value of the current policy and at the same time the policy is being improved optimality with respect to its value function, as in the following diagram.
<figure>
...
<figure>
	...
	<figcaption style="text-align: center;font-style: italic;"><b>Figure 8</b>: Interaction between the evalution and improvement processes in GPI</figcaption>
</figure>
...
[^1]: In the third step, the expression
	...
	\begin{equation}
	\mathbb{E}\_{\pi'}\left[R_{t+1}+\gamma v_\pi(S_{t+1})|S_t=s\right]=\mathbb{E}\_{\pi'}\left[R_{t+1}+\gamma v_\pi(S_{t+1})|S_t=s\right]
	\end{equation}  
