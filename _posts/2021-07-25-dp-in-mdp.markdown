...
tags: artificial-intelligent reinforcement-learning dynamic-programming planning my-rl
...
<figure>
    ...
    <figcaption style="text-align: center;font-style: italic;"><b>Figure 3</b>: Policy Iteration on Jack's car rental task. The code can be found <span markdown="1">[here](https://github.com/trunghng/reinforcement-learning-an-introduction-imp/blob/main/chapter-4/jackscar.py)</span></figcaption>
</figure><br/>
