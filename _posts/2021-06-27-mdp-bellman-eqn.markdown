...
The proof of the above theorem is provided in another [note]({% post_url 2021-07-10-optimal-policy-existence %}) since we need some additional tools to do that.  
