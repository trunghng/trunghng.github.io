...
\end{equation}
Taking the gradient of the above function w.r.t $\theta$ using the **log-likelihood trick** as in [REINFORCE]({% post_url 2022-05-04-policy-gradient-theorem %}#reinforce) gives us
\begin{align}
...
<figure>
	...
	<figcaption style="text-align: center;font-style: italic;"><b>Figure 1</b>: Success rate to reach $f_\text{stop}=10^{-10}$ versus population size for Rastrigin function.<br> The code can be found <span markdown="1">[here](https://github.com/trunghng/evolution-strategies/blob/main/testing_ground.py)</span></figcaption>
</figure>
