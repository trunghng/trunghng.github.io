...
- [Natural gradient for MVN](#ntr-grad-mvn)
...
### Natural gradient for MVN
{: #ntr-grad-mvn}
When our search distribution is in form of a Mulivariate Normal, the Fisher information matrix $\mathbf{F}$
