...
\begin{align}
&\hspace{-1cm}D(\theta+\delta\theta\Vert\theta)\nonumber \\\\ &=\mathbb{E}\_{\theta+\delta\theta}\big[\log\pi(\mathbf{z}\vert\theta+\delta\theta)-\log\pi(\mathbf{z}\vert\theta)\big] \\\\ &\approx\mathbb{E}\_{\theta+\delta\theta}\left[\log\pi(\mathbf{z}\vert\theta)+\delta\theta^\text{T}\frac{\nabla_\theta\pi(\mathbf{z}\vert\theta)}{\pi(\mathbf{z}\vert\theta)}-\frac{1}{2}\delta\theta^\text{T}\frac{\nabla_\theta\pi(\mathbf{z}\vert\theta)\nabla_\theta\pi(\mathbf{z}\vert\theta)^\text{T}}{\pi(\mathbf{z}\vert\theta)^2}\delta\theta-\log\pi(\mathbf{z}\vert\theta)\right] \\\\ &=\mathbb{E}\_{\theta+\delta\theta}\left[\delta\theta^\text{T}\nabla_\theta\log\pi(\mathbf{z}\vert\theta)-\frac{1}{2}\delta\theta^\text{T}\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\nabla_\theta\log\pi(\mathbf{z}\vert\theta)^\text{T}\delta\theta\right] \\\\ &=\mathbb{E}\_{\theta+\delta\theta}\Big[\delta\theta^\text{T}\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\Big]-\mathbb{E}\_{\theta+\delta\theta}\left[\frac{1}{2}\delta\theta^\text{T}\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\nabla_\theta\log\pi(\mathbf{z}\vert\theta)^\text{T}\delta\theta\right] \\\\ &=-\frac{1}{2}\int\pi(\mathbf{z}\vert\theta+\delta\theta)\delta\theta^\text{T}\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\nabla_\theta\log\pi(\mathbf{z}\vert\theta)^\text{T}\delta\theta\,d\mathbf{z} \\\\ 
\end{align}
where in the fifth step, we have used that
\begin{align}
\mathbb{E}\_{\theta+\delta\theta}\Big[\delta\theta^\text{T}\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\Big]&=\int\pi(\mathbf{z}\vert\theta+\delta\theta)\delta\theta^\text{T}\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\,d\mathbf{z} \\\\ &=\int\pi(\mathbf{z}\vert\theta+\delta\theta)\frac{1}{\pi(\mathbf{z}\vert\theta+\delta\theta)}\nabla_\theta\pi(\mathbf{z}\vert\theta+\delta\theta)\,d\mathbf{z} \\\\ &=\nabla_\theta\int\pi(\mathbf{z}\vert\theta+\delta\theta)\,d\mathbf{z} \\\\ &=\nabla_\theta 1=0
\end{align}

where $\mathbf{F}$ is the **Fisher information matrix**, defined as
\begin{align}
\mathbf{F}&=\int\pi(\mathbf{z}\vert\theta)\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\nabla_\theta\log\pi(\mathbf{z}\vert\theta)^\text{T}\,d\mathbf{z} \\\\ &=\mathbb{E}\big[\nabla_\theta\log\pi(\mathbf{z}\vert\theta)\nabla_\theta\log\pi(\mathbf{z}\vert\theta)^\text{T}\big]
\end{align}
